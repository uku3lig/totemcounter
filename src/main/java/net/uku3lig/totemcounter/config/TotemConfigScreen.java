...
public class TotemConfigScreen extends TabbedConfigScreen<TotemCounterConfig> {
    ...
    public static class PopCounterTab extends ButtonTab<TotemCounterConfig> {
    ...
    public static class TotemDisplayTab extends ButtonTab<TotemCounterConfig> {
    ...
    public static class ExperimentalTab extends ButtonTab<TotemCounterConfig> {
